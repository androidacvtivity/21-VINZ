    ...
    for (var i = 10; i <= 136; i++) {
        {
            ...
            if (col1 > 0 && col2 == 0) {
                webform.errors.push({
                    ...
                    'weight': 2,
                    'msg': Drupal.t('Cod eroare: 26-004 Cap.I, daca exista COL1 atunci exista COL2  pe  rindurile. @row', { '@row': i })
                });
                ...
                webform.errors.push({
                    'fieldName': 'CAP1_R' + (i <= 136 ? (+ i) : i) + '_C1',
                    'weight': 2,
                    'msg': Drupal.t('Cod eroare: 26-004 Cap.I, daca exista COL2 atunci exista COL1  pe  rindurile. @row', { '@row': i })
                });
