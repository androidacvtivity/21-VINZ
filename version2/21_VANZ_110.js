    ...
    for (var i = 10; i <= 136; i++) {
        {
           ...
           var col2DevCol1 = Math.round((Number(values["CAP1_R" + i + "_C2"]) / Number(values["CAP1_R" + i + "_C1"])) * 100) / 100;
    ...
    for (var i = 10; i <= 136; i++) {
        {
            ...
            if (!isNaN(Number(values["CAP1_R" + i + "_C4"])) && !isNaN(Number(values["CAP1_R" + i + "_C5"]))
                ...
                var col5DevCol4 = Math.round((Number(values["CAP1_R" + i + "_C5"]) / Number(values["CAP1_R" + i + "_C4"])) * 100) / 100;
